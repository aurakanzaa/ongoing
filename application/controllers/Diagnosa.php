...
class Diagnosa extends CI_Controller
{
    ...
    public function filter_berdasarkan_poli()
    {
        ...
        // if ($this->form_validation->run() == FALSE) {
            $this->template->load('template','diagnosa/filter',$data);
        // } else {
    ...
    public function filter_action()
    {
        ...
        $this->form_validation->set_rules('hidden', 'Hidden', 'trim|required');
        if ($this->form_validation->run() == FALSE) {
            $this->template->load('template','diagnosa/filter_action',$data);
        } else {
            $poli = $this->input->post('nama_poli');
            $data['diagnosa'] = $this->Tbl_diagnosa_penyakit_model->getByPoli($poli);
            $data['id_poli'] = $poli;
            $this->template->load('template','diagnosa/filter_action',$data);
        }
    }
    ...
    public function create() 
    {
        ...
        'nama_poli' => $this->Tbl_poli_model->get_all(),
	);
