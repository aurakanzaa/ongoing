...
class Polikia extends CI_Controller
{
   ...
   function cetak(){
      ...
      $sql_data_kia= "SELECT * FROM tbl_kesehatan_ibu_anak";
        ...
        $pdf->Cell(40, 7, 'Tgl Tindakan  ', 1, 0, 'C');
        $pdf->Cell(30, 7, 'Jam Tindakan  ', 1, 1, 'C');
        ...
        $pdf->Cell(40, 7, $r->tgl_tindakan, 1, 0, 'C');
        $pdf->Cell(30, 7, $r->jam_tindakan, 1, 1, 'C');
        }
   ...
   function cetakid($id){
    ...
    public function create() 
    {
      ...
      $sql_daftar = "SELECT pd.no_rekamedis, pd.no_rawat,ps.nama_pasien FROM tbl_pendaftaran as pd, tbl_pasien as ps WHERE pd.no_rekamedis = ps.no_rekamedis and pd.no_rawat = '$no_rawat'";
        ...
        'jam_tindakan' => set_value('jam_tindakan'),
	);
    ...
    public function create_action() 
    {
        ...
        'jam_tindakan' => $this->input->post('jam_tindakan',TRUE),
	    );
    ...
    public function update($id) 
    {
        ...
        'jam_tindakan' => set_value('jam_tindakan', $row->jam_tindakan),
	    );
            $this->template->load('template','polikia/tbl_kesehatan_ibu_anak_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
    ...
    $this->form_validation->set_rules('jam_tindakan', 'jam tindakan', 'trim|required');
