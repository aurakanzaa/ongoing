...
class Pasien extends CI_Controller
{
    ...
    $sql_rekamedis    = "SELECT tr.*,pd.no_rawat,pd.tanggal_daftar 
        ...
        $pdf = new FPDF('l', 'mm', array(450,380));
        // membuat halaman baru
        $pdf->AddPage();
        // setting jenis font yang akan digunakan
        $pdf->SetFont('Arial', 'B', 16);

        $pdf->Image('assets/foto_profil/logo-rs.jpg', 75, 5, 30);
        //$pdf->Image('', )
        // mencetak string 
        $pdf->Cell(45, 7, '', 0, 0, 'C');
        ...
        $pdf->Cell(30, 7, $r->desa, 1, 0, 'C');
        $pdf->Cell(70, 7, $r->alamat, 1, 0, 'C');
    ...
    {
        $this->template->load('template','pasien/cek_bpjs');
