...
class Dokter extends CI_Controller
{
    ...
    $no_rawat = substr($this->uri->uri_string(3), 27);
      ...
      $sql_data_resep = "SELECT dok.kode_dokter,dok.nama_dokter,dok.jenis_kelamin,dok.nomor_induk_dokter,dok.tempat_lahir,dok.tgl_lahir,dok.alamat,dok.no_telp, pol.nama_poli FROM tbl_dokter as dok, tbl_poli as pol WHERE dok.id_poli = pol.id_poli";
    ...
    public function update($id) 
    {
        ...
        'no_telp' => set_value('id_poli', $row->no_telp),
	    );
            $this->template->load('template','dokter/tbl_dokter_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
