...
//halo
class Historytindakan extends CI_Controller
{
   ...
   public function index($level)
    {
        ...
        if ($poli == "POLI") {
            $pendaftaran = $this->Tbl_pendaftaran_rekmed_model->get_limit_data_poli2($config['per_page'], $start, $polipoli);
        }
        else{
            $pendaftaran = $this->Tbl_pendaftaran_rekmed_model->get_limit_data2($config['per_page'], $start, $q);
        }
