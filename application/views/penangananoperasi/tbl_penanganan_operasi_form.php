      ...
      <form action="<?php echo $action; ?>" method="post" id="form1" name="form1">
         <div class="table-responsive">
            ...
            <tr>
               ...
               <td><input type="text" class="form-control" name="nama_pasien" id="nama_pasien" placeholder="Nama Pasien" onkeyup="autopasien()" /></td>
            </tr>
            <tr>
            ...
            <tr>
               <td width='200'>Nama Operasi <?php echo form_error('nama_operasi') ?></td>
               <td><input type="text" class="form-control" name="nama_operasi" id="nama_operasi" placeholder="Nama Operasi" onkeyup="autooperasi()" /></td>
            </tr>
            <tr>
               <td width='200'>Biaya <?php echo form_error('biaya') ?></td>
               <td><input type="text" class="form-control" name="biaya" id="biaya" placeholder="Biaya" readonly onkeyup="hitung()" /></td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td><input type="text" class="form-control" name="dibayar" id="dibayar" placeholder="Dibayar" onkeyup="hitung()" /></td>
            </tr>
            <tr>
               <td width='200'>Kembalian <?php echo form_error('kembalian') ?></td>
               <td><input type="text" class="form-control" name="kembalian" id="kembalian" placeholder="Kembalian" readonly="" /></td>
            </tr>
            <tr>
            ...
            <tr>
               <td width='200'>Tgl Operasi <?php echo form_error('tgl_operasi') ?></td>
               <td><input type="date" class="form-control" name="tgl_operasi" id="tgl_operasi" placeholder="Tgl Operasi" value="<?php echo date('Y-m-d') ?>" /></td>
            </tr>
            <tr>
               <td></td>
               <td><input type="hidden" name="id_penanganan" value="<?php echo $id_penanganan; ?>" /> 
