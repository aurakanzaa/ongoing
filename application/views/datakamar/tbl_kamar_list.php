<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor(site_url('datakamar/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "datakamar/json", "type": "POST"},
                    columns: [
                        {
                            "data": "kode_kamar",
                            "orderable": false
                        },{"data": "kode_kamar"},{"data": "nama_kamar"},{"data": "kelas_kamar"},{"data": "kapasitas"},{"data": "harga"},{"data": "stok"},
                        {
                            "data" : "action",
                            "orderable": false,
