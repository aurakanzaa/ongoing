            ...
            <div class="col-xs-12">
                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA PENGELUARAN OBAT NON PASIEN</h3>
                    </div>
        <!-- halo -->
        <div class="box-body">
        <div style="padding-bottom: 10px;">
        <?php echo anchor(site_url('obatnonpasien/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
		<?php echo anchor(site_url('obatnonpasien/cetak'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak Data', 'class="btn btn-primary btn-sm"'); ?></div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "obatnonpasien/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_obatnonpasien",
                            "orderable": false
                        },{"data": "no_trans"},{"data": "supplier"},{"data": "nama_obat"},{"data": "jenis_obat"},{"data": "jumlah"},{"data": "satuan"},{"data": "kode_ruang"},
                        {
                            "data" : "action",
                            "orderable": false,
