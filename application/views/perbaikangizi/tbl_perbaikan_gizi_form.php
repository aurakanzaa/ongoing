      ...
      <form action="<?php echo $action; ?>" method="post">
        <div class="table-responsive">
         ...
         <tr>
            ...
            <td><input type="text" class="form-control" name="nama_tindakan" id="nama_tindakan" value="<?php echo $nama_tindakan ?>" placeholder="Nama Tindakan" onkeyup="tindakanauto()" /></td>
         </tr>
         <tr>
            <td width='200'>Nama Obat <?php echo form_error('nama_obat') ?></td>
            <td><input type="text" class="form-control" name="nama_obat" id="nama_obat" value="<?php echo $nama_obat ?>" placeholder="Nama Obat" onkeyup="obatauto()" /></td>
         </tr>
         <tr>
            <td width='200'>Jumlah <?php echo form_error('jumlah') ?></td>
            <td><input type="text" class="form-control" name="jumlah" value="<?php echo $jumlah?>" id="jumlah" placeholder="Jumlah" value="<?php echo $jumlah; ?>" /></td>
         </tr>
         <tr>
         ...
         <tr>
            <td></td>
            <td><input type="hidden" name="id_gizi" value="<?php echo $id_gizi; ?>" /> 
