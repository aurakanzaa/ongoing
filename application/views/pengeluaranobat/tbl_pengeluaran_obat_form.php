      ...
      <form action="<?php echo $action; ?>" method="post">
        <div class="table-responsive">
         <table class='table table-bordered'>
            <tr>
               <td width='200'>No Terima Obat <?php echo form_error('no_terima_obat') ?></td>
               <td><input type="text" class="form-control" name="no_terima_obat" id="no_terima_obat" placeholder="No Terima Obat" value="<?php echo "S-".date('ymd')."-".noPengeluaranOtomatis(); ?>" readonly /></td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td><input type="text" class="form-control" name="nama_obat" id="nama_obat" placeholder="Nama Obat" onkeyup="obatAuto()" /></td>
            </tr>
            <tr>
               <td width='200'>Kode Obat <?php echo form_error('kode_obat') ?></td>
               <td><input type="text" class="form-control" name="kode_obat" id="kode_obat" placeholder="Kode Obat"  /></td>
            </tr>
            <tr>
               <td width='200'>Jenis Obat <?php echo form_error('jenis_obat') ?></td>
               <td><input type="text" class="form-control" name="jenis_obat" id="jenis_obat" placeholder="Jenis Obat" /></td>
            </tr>
            <tr>
               <td width='200'>Dosis Aturan Obat <?php echo form_error('dosis_aturan_obat') ?></td>
               <td><input type="text" class="form-control" name="dosis_aturan_obat" id="dosis_aturan_obat" placeholder="Dosis Aturan Obat"  /></td>
            </tr>
            <tr>
            ...
            <tr>
               <td></td>
               <td><input type="hidden" name="id_pengeluaran" value="<?php echo noPengeluaranOtomatis(); ?>" />
            <tr>
               <td></td>
               <td><input type="hidden" name="tgl_serah_obat" id="tgl_serah_obat" value="<?php echo date('d-m-Y'); ?>" />
                  <button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
                  <a href="<?php echo site_url('pengeluaranobat') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
               </td>
            </tr>
         </table>
     </div>
