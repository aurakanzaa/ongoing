    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                ...
                <!-- <a href="<?php echo site_url('pasien/cekBpjs')?>" class="btn btn-default pull-right">CEK BPJS</a> -->
            </div>
...
<table class='table table-bordered'>
    ...
    <select id="status_pasien" name="status_pasien" onchange="tampilkan()" class="form-control">
      ...
      <tr><td width='200'>Kontak<?php echo form_error('no_telp') ?></td><td><input type="text" class="form-control" name="no_telp" id="no_telp" placeholder="Kontak" value="<?php echo $no_telp; ?>" /></td></tr>
      ...
      <tr><td width='200'>Desa <?php echo form_error('desa') ?></td><td>
       ...
       <select id="desa" name="desa" onchange="tampilkan()" class="form-control">
           ...
           <option value="Craken">Craken</option>
           <option value="Karangturi">Karangturi</option>
           <option value="Masaran">Masaran</option>
           <option value="Munjungan">Munjungan</option>
           <option value="Ngulungkulon">Ngulungkulon</option>
           <option value="Ngulungwetan">Ngulungwetan</option>
           <option value="Sobo">Sobo</option>
           <option value="Tawing">Tawing</option>
      ...
      <tr><td width='200'>Alamat <?php echo form_error('alamat') ?></td><td> <textarea class="form-control" rows="3" name="alamat" id="alamat" placeholder="Alamat"><?php echo $alamat; ?></textarea></td></tr><tr><td></td><td>
