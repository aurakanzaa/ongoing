<div class="content-wrapper">
   ...
   <div class="col-md-6">
      <div class="box box-warning box-solid">
         <div class="box-header with-border">
            ...
            <a href="<?php echo site_url('pasien/cekBpjs')?>" class="btn btn-success pull-right">CEK BPJS</a>
         </div>
            ...
            <div class="table-responsive">
               <table class='table table-bordered'>
                  <tr>
                     ...
                     <td><input type="text" class="form-control" name="no_rawat" id="no_rawat" value="<?php echo date('Y-m-d-').noRegistrasiotomatis(); ?>" readonly /></td>
                  </tr>
                  <tr>
                     <td width='200'>Dokter Penanggung Jawab <?php echo form_error('kode_dokter_penanggung_jawab') ?></td>
                     <!-- <td><input type="text" class="form-control" onkeyup="auto_nama_dokter()" name="kode_dokter_penanggung_jawab" id="kode_dokter_penanggung_jawab" placeholder="Dokter Penanggung Jawab" value="<?php echo $kode_dokter_penanggung_jawab; ?>"/></td> -->
                     <!-- <td><?php echo cmb_dinamis('kode_dokter_penanggung_jawab', 'tbl_dokter', 'nama_dokter', 'kode_dokter_penanggung_jawab',$kode_dokter_penanggung_jawab)?></td> -->
                     <td>
                        <select name="kode_dokter_penanggung_jawab" id="inputkode_dokter_penanggung_jawab" class="form-control" required="required">
                  ...
                  <tr>
                     <td></td>
                     <td><input type="hidden" class="form-control" name="tanggal_daftar" id="tanggal_daftar" placeholder="Tanggal Daftar" value="<?php echo date('Y-m-d'); ?>" /> 
   ...
   <tr><td width='200'>Status Pasien <?php echo form_error('status_pasien') ?></td>
   <td>
   ...
   <select id="hubungan" name="hubungan_dengan_penanggung_jawab" onchange="tampilkan_hubungan()" class="form-control">
   <option value="" disabled="disabled" selected>Pilih</option>
   ...
   <tr><td width='200'>Hubungan <?php echo form_error('hubungan_dengan_penanggung_jawab') ?></td><td><input type="text" class="form-control" name="hubungan_dengan_penanggung_jawab" id="hubungan_lainnya" placeholder="Lainnya" value="<?php echo $hubungan_dengan_penanggung_jawab; ?>" /></td></tr>
...
<script type="text/javascript">
   ...
   function tampilkan_hubungan(){
   var hubungan_lainnya=document.getElementById("form1").hubungan.value;
   if (hubungan_lainnya=="Lainnya")
   {
       document.getElementById("hubungan_lainnya").value = ""; 
       document.getElementById("hubungan_lainnya").readOnly = false;
   }
   else
   {
       document.getElementById("hubungan_lainnya").value = hubungan_lainnya; 
      document.getElementById("hubungan_lainnya").readOnly = true;
   }
   }
