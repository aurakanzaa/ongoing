   ...
   <body>
      ...
      <div class="table-responsive">
         <table class="table">
            ...
            <tr>
               <td>No Izin Paramedis</td>
               <td><?php echo $no_izin_paramedis; ?></td>
            </tr>
            <tr>
               <td>Tempat Lahir</td>
            ...
            <tr>
               <td></td>
               <td><a href="<?php echo site_url('paramedis') ?>" class="btn btn-default">Cancel</a></td>
            </tr>
         </table>
      </div>
   </body>
