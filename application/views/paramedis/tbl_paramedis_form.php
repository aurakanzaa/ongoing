      ...
      <form action="<?php echo $action; ?>" method="post">
         <div class="table-responsive">
            <table class='table table-bordered'>
               <!-- halo -->
               <tr>
                  <td width='200'>Kode Paramedis <?php echo form_error('id_') ?></td>
                  <td><input type="text" class="form-control" name="kode_paramedis" id="kode_paramedis" placeholder="Kode Paramedis" value="<?php echo $kode_paramedis; ?>" /></td>
               </tr>
               <tr>
                  <td width='200'>Nama Paramedis <?php echo form_error('nama_paramedis') ?></td>
                  <td><input type="text" class="form-control" name="nama_paramedis" id="nama_paramedis" placeholder="Nama Paramedis" value="<?php echo $nama_paramedis; ?>" /></td>
               </tr>
               <tr>
               ...
               <tr>
                  <td width='200'>No Izin Paramedis <?php echo form_error('no_izin_paramedis') ?></td>
                  <td><input type="text" class="form-control" name="no_izin_paramedis" id="no_izin_paramedis" placeholder="No Izin Paramedis" value="<?php echo $no_izin_paramedis; ?>" /></td>
               </tr>
               <tr>
               ...
               <tr>
                  <td width='200'>Poli <?php echo form_error('id_poli') ?></td>
                  <td>
