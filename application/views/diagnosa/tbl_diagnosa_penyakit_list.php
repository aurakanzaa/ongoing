         ...
         <div class="box box-warning box-solid">
            ...
            <div class="box-body">
               <div style="padding-bottom: 10px;">
                  ...
                  <?php echo anchor(site_url('diagnosa/filter_berdasarkan_poli'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Filter Berdasarkan Poli', 'class="btn btn-danger btn-sm"'); ?>
                </div>
           ...
           columns: [
               {
                   "data": "kode_diagnosa",
                   "orderable": false
               },{"data": "kode_diagnosa"},{"data": "nama_penyakit"},{"data": "ciri_ciri_penyakit"},{"data": "keterangan"},{"data": "ciri_ciri_umum"},{"data": "nama_poli"},
               {
                   "data" : "action",
                   "orderable": false,
