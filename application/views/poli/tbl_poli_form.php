   ...
   <div class="box box-warning box-solid">
      ...
      <form action="<?php echo $action; ?>" method="post">
         <table class='table table-bordered'>
            ...
            <tr>
               <td width='200'>Ruang Poli <?php echo form_error('ruang_poli') ?></td>
               <td><input type="text" class="form-control" name="ruang_poli" id="ruang_poli" placeholder="Ruang Poli" value="<?php echo $ruang_poli; ?>" /></td>
            </tr>
            <tr>
               <td></td>
               <td><input type="hidden" name="id_poli" value="<?php echo $id_poli; ?>" /> 
