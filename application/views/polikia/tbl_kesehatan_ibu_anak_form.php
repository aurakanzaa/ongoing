        ...
        <div class="table-responsive">
         <table class='table table-bordered'>
            <tr>
               ...
               <td><input type="text" class="form-control" name="nama_pasien" id="nama_pasien" placeholder="Nama Pasien" value="<?php echo $pendaftaran['nama_pasien'] ?>" onkeyup="pasienauto()" /></td>
            </tr>
            <tr>
               <td width='200'>No BPJS <?php echo form_error('no_bpjs') ?></td>
               <td><input type="text" class="form-control" name="no_bpjs" id="no_bpjs" placeholder="No BPJS" /></td>
            </tr>
            <tr>
            ...
            <tr>
               <td width='200'>Nama Tindakan <?php echo form_error('nama_operasi') ?></td>
               <td><input type="text" class="form-control" value="<?php echo $nama_operasi ?>" name="nama_operasi" id="nama_operasi" placeholder="Nama Tindakan" onkeyup="tindakanauto()"  /></td>
            </tr>
            <tr>
               <td width='200'>Biaya <?php echo form_error('biaya') ?></td>
               <td><input type="text" class="form-control" name="biaya" id="biaya" value="<?php echo $biaya ?>" placeholder="Biaya" readonly onkeyup="hitung()" /></td>
            </tr>
            <tr>
               <td width='200'>Ditangani Oleh <?php echo form_error('ditangani_oleh') ?></td>
               <td>
            ...
            <tr>
               <td width='200'>Dibayar <?php echo form_error('dibayar') ?></td>
               <td><input type="text" class="form-control" name="dibayar" id="dibayar" value="<?php echo $dibayar ?>" placeholder="Dibayar" onkeyup="hitung()" /></td>
            </tr>
            <tr>
               <td width='200'>Kembalian <?php echo form_error('kembalian') ?></td>
               <td><input type="text" class="form-control" name="kembalian" id="kembalian" value="<?php echo $kembalian
                  ?>" placeholder="Kembalian" readonly="" /></td>
            </tr>
            <tr>
               <td width='200'>Keterangan <?php echo form_error('keterangan') ?></td>
               <td><input type="text" class="form-control" name="keterangan" id="keterangan" placeholder="Keterangan" readonly="" /></td>
            </tr>
            <tr>
               <td width='200'>Tgl Tindakan <?php echo form_error('tgl_tindakan') ?></td>
               <td><input type="date" class="form-control" name="tgl_tindakan" value="<?php echo date('Y-m-d') ?>" id="tgl_tindakan" placeholder="Tgl Tindakan" /></td>
            </tr>
            <tr>
               <td width='200'>Jam Tindakan <?php echo form_error('jam_tindakan') ?></td>
               <td><input type="time" class="form-control" name="jam_tindakan" id="jam_tindakan" value="<?php echo $jam_tindakan ?>" placeholder="Jam tindakan"/></td>
            </tr>
            <tr>
               <td></td>
               <td><input type="hidden" name="id_kia" value="<?php echo $id_kia; ?>" /> 
