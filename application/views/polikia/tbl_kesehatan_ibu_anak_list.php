            ...
            <div class="box box-warning box-solid">
               ...
               <div class="box-body">
                  <div style="padding-bottom: 10px;">
                     ...
                     <?php echo anchor(site_url('polikia/cetak'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak Data', 'class="btn btn-success btn-sm"'); ?>
                  </div>
           ...
           columns: [
               {
                   "data": "id_kia",
                   "orderable": false
               },{"data": "nama_pasien"},{"data": "status_pasien"},{"data": "nama_operasi"},{"data": "biaya"},{"data": "ditangani_oleh"},{"data": "tgl_tindakan"},{"data":"jam_tindakan"},
               {
                   "data" : "action",
                   "orderable": false,
