<div class="content-wrapper">
    <section class="content">
        ...
        <div class="box-body">
            ...
            <div class='col-md-9'>
                <div style="padding-bottom: 10px;">
                    <?php if($this->uri->segment(1) == 'historytindakan'){ ?>
                        <a href="<?php echo site_url('tindakanberobat/index/'.$this->uri->segment(3)) ?>" class="btn btn-primary">Kembali</a>
                    <?php }else{ ?>
                        <a href="<?php echo site_url('historytindakan/index/'.$this->uri->segment(3)) ?>" class="btn btn-primary">Lihat History</a>
                    <?php } ?>
                </div>
            </div>
            <div class='col-md-3'>
        ...
        <div class="table-responsive">
            <!-- <?php echo $level ?> -->
            <?php $poli = substr($level,0,4); ?>
            <?php $namapoli = substr($level,7); ?>
            <?php $polipoli = $poli." ".$namapoli ?>
