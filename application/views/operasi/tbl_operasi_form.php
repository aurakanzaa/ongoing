      ...
      <form action="<?php echo $action; ?>" method="post">
         <div class="table-responsive">
            <table class='table table-bordered'>
               <tr>
                  <td width='200'>Kode Operasi <?php echo form_error('kode_operasi') ?></td>
                  <td><input type="text" class="form-control" name="kode_operasi" id="kode_operasi" placeholder="Kode Operasi" value="<?php echo $kode_operasi; ?>" /></td>
               </tr>
               <tr>
                  <td width='200'>Nama Operasi <?php echo form_error('nama_operasi') ?></td>
                  <td><input type="text" class="form-control" name="nama_operasi" id="nama_operasi" placeholder="Nama Operasi" value="<?php echo $nama_operasi; ?>" /></td>
               </tr>
               <tr>
