      ...
      <form action="<?php echo $action; ?>" method="post">
         <div class="table-responsive">
            <table class='table table-bordered'>
               ...
               <tr>
                  <td width='200'>Nomor Induk Dokter <?php echo form_error('nomor_induk_dokter') ?></td>
                  <td><input type="text" class="form-control" name="nomor_induk_dokter" id="nomor_induk_dokter" placeholder="Nomor Induk Dokter" value="<?php echo $nomor_induk_dokter; ?>" /></td>
               </tr>
               <tr>
