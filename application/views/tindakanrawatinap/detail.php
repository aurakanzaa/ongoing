         ...
         <div class="col-xs-12">
            <div class="box box-warning box-solid">
               ...
               <div class="box-body">
                  ...
                  <?php if($pendaftaran['status_periksa'] == "Belum Diperiksa" || $pendaftaran['status_periksa'] == "Rawat Inap"){ ?>
                  ...
                  <?php endif ?>
                  <?php if($pendaftaran['status_periksa'] == 'Rawat Inap'){ ?>
                     <a href="<?php echo site_url('pengeluarankamar') ?>" class="btn btn-default">Pesan Kamar</a>
                     <a href="<?php echo site_url('pengeluarankamar/checkout/'.$pendaftaran['no_rawat']) ?>" class="btn btn-danger">Checkout</a>
                  <?php } ?>
               </div>
            </div>
         </div>
                        ...
                        <?php  
                           ...
                           foreach ($data_tindakan as $dt){
                              ...
                              echo "<tr>
                                       ...
                                       <td>$dt->keluhan</td>
                                       <td>$dt->pemeriksaan_fisik</td>
                                       <td>$dt->pemeriksaan_lab</td>
                                       <td>$dt->nama_tindakan</td>
                                       <td>$dt->deskripsi</td>"; ?>
                                       
                                       <?php if ($pendaftaran['status_periksa'] == 'Belum Diperiksa') { ?>
                                          <td>
                                          <a href='<?php echo site_url('tindakanberobat/edittindakan/'.$dt->id_riwayat_tindakan.'/'.$this->uri->segment(3)
                                          )?>' onclick='javasciprt: return confirm(\"Are You Sure ?\")' class="btn btn-warning"><i class='fa fa-edit' aria-hidden='true'></i></a>
                                          <a href='<?php echo site_url('tindakanberobat/deletetindakan/'.$dt->id_riwayat_tindakan.'/'.$this->uri->segment(3)
                                          )?>' onclick='javasciprt: return confirm(\"Are You Sure ?\")' class="btn btn-danger"><i class='fa fa-trash-o' aria-hidden='true'></i></a>
                                       <?php } ?>
   ...
   <div class="modal-dialog modal-lg" role="dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <?php echo form_open('rawatinap/periksa_action/'.$this->uri->segment(3)); ?>
            <table class="table table-bordered ">
               ...
               <tr>
                  <td>Keluhan</td>
                  <td><input type="text" name="keluhan" class="form-control" placeholder="Masukkan Keluhan" id="keluhan" required></td>
               </tr>
               <tr>
                  <td>Pemeriksaan Fisik</td>
                  <td><input type="text" name="pemeriksaan_fisik" class="form-control" placeholder="Pemeriksaan Fisik" id="pemeriksaan_fisik" required></td>
               </tr>
               <tr>
                  <td>Pemeriksaan Lab</td>
                  <td><input type="text" name="pemeriksaan_lab" class="form-control" placeholder="Pemeriksaan Lab" id="pemeriksaan_lab" required></td>
               </tr>
               <tr>
                  <td>Nama Tindakan</td>
               ...
               <tr>
                  <td>Kode ICD 10</td>
                  <td><input type="text" name="kode_icd" class="form-control ui-autocomplete-input" placeholder="Masukkan Kode ICD 10" id="kode_icd" onkeyup="auto_kode_icd()" required></td>
               </tr>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <table class="table table-bordered ">
               ...
               <input value="<?php echo $pendaftaran['no_rawat'] ?>" name="no_rawat" type="hidden">
               <input value="<?php echo $pendaftaran['no_rekamedis'] ?>" name="no_rekamedis" type="hidden">
               <tr>
                  <td>Nama Obat</td>
                  <td>
...
<script type="text/javascript">
   ...
   function auto_kode_icd(){
       //autocomplete
       $("#kode_icd").autocomplete({
           source: "<?php echo base_url() ?>index.php/tindakanberobat/autocompleteIcd",
           minLength: 1
       });
   }
