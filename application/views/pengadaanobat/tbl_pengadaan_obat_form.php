         ...
         <div class="table-responsive">
            <table class='table table-bordered' >
               ...
               <tr>
                  ...
                  <td><input type="text" class="form-control" name="no_trans" id="no_trans" placeholder="Nomor Transaksi" value="<?php echo "B-".date("ymd")."-".$id_pengadaan;?>" readonly  /></td>
               </tr>
               <tr>
                  <td width='200'>Supplier <?php echo form_error('supplier') ?></td>
                  <td><input type="text" class="form-control" name="supplier" id="supplier" placeholder="Supplier" onkeyup="autosupplier()" required="" /></td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td><input type="text" class="form-control" name="kode_obat" id="kode_obat" placeholder="Kode Obat" required="" readonly /></td>
               </tr>
               <tr>
                  <td width='200'>Jenis Obat <?php echo form_error('jenis_obat') ?></td>
                  <td><input type="text" class="form-control" name="jenis_obat" id="jenis_obat" placeholder="Jenis Obat" required="" readonly=""  /></td>
               </tr>
               <tr>
                  <td width='200'>Harga Beli <?php echo form_error('harga_beli') ?></td>
                  <td><input type="text" class="form-control" name="harga_beli" id="harga_beli" placeholder="Harga Beli" onkeyup="count()" required="" /></td>
               </tr>
               ...
               <tr>
                  ...
                  <td><input type="text" class="form-control" name="total" id="total" placeholder="Total" readonly /></td>
               </tr>
               <tr>
                  <td></td>
                  <td><input type="hidden" name="id_pengadaan" value="<?php echo $id_pengadaan; ?>" /> 
