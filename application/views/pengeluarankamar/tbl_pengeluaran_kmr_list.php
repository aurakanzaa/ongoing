            ...
            <div class="col-xs-12">
                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA PENGELUARAN KAMAR</h3>
                    </div>
        
        <div class="box-body">
        <div style="padding-bottom: 10px;">
        <?php echo anchor(site_url('pengeluarankamar/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
		<?php echo anchor(site_url('pengeluarankamar/cetak'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak Data', 'class="btn btn-primary btn-sm"'); ?></div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "pengeluarankamar/json", "type": "POST"},
                    columns: [
                        {
                            "data": "no_terima_kamar",
                            "orderable": false
                        },{"data": "id_pengeluaran"},{"data": "nama_pasien"},{"data": "nama_kamar"},{"data": "kelas_kamar"},{"data": "kapasitas"},{"data": "harga"},{"data": "tanggal_masuk"},{"data": "tanggal_keluar"},{"data": "keterangan"},
                        {
                            "data" : "action",
                            "orderable": false,
