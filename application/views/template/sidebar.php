<section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree" style="font-size: 13.4px">
        ...
        foreach ($main_menu as $menu){
            ...
            if($submenu->num_rows()>0){
                ...
                echo "<li class='treeview'>
                        ...
                        foreach ($submenu->result() as $sub){
                            if($sub->url == "rawatinap/index"){
                                echo "<li>".anchor($sub->url.'/'.$level,"<i class='$sub->icon'></i> ".strtoupper($sub->title))."</li>"; 
                            }
                            else{
            ...
            }else if($menu->url == "tindakanberobat/index"){
                // display main menu
                echo "<li>";
                echo "<a href='".site_url($menu->url."/".$level)."'> <i class='".$menu->icon."'></i>".strtoupper($menu->title)."</a>";
