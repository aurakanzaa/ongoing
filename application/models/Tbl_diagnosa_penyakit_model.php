...
// halo
    // datatables
    function json() {
        $this->datatables->select('kode_diagnosa,nama_penyakit,ciri_ciri_penyakit,keterangan,ciri_ciri_umum,nama_poli');
    ...
    public function getByPoli($nama_poli)
    {
        ...
        // $this->db->join('tbl_poli', 'tbl_poli.id_poli = tbl_tindakan.id_poliklinik');
        return $this->db->get('tbl_diagnosa_penyakit')->result();
    }
