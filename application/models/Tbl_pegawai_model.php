...
// halo
    // datatables
    function json() {
        $this->datatables->select('id_pegawai,nama_pegawai,jenis_kelamin,npwp,tempat_lahir,tanggal_lahir,nama_jabatan,nama_bidang,no_telp,pendidikan,no_kepeg,status_kepeg,nik,alamat');
    ...
    $this->db->or_like('no_kepeg', $q);
    $this->db->or_like('status_kepeg', $q);
