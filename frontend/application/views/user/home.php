...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
        ...
        <div class="col-xl-12 col-sm-6 mb-6">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><b>Rekam Medis</b></div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="<?php echo site_url('rekammedis') ?>">
              <span class="float-left">Lihat Rekam Medis</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
            </a>
    ...
    <script src="<?php echo base_url() ?>/assets/template/<?php echo base_url() ?>/assets/template/vendor/datatables/jquery.dataTables.js"></script>
    ...
    <script src="<?php echo base_url() ?>/assets/template/<?php echo base_url() ?>/assets/template/js/sb-admin-datatables.min.js"></script>
